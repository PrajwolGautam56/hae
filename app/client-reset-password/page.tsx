  ...
  useEffect(() => {
    void (async () => {
      ...
      if (tokenHash) {
        ...
        setReady(true);
        setMessage("Link verified. Choose your customer portal password.");
      ...
      if (data.session) {
        setReady(true);
        setMessage("Link verified. Choose your customer portal password.");
      } else setMessage("This password link is invalid or expired.");
    })();
  }, [supabase]);
  async function save() {
    ...
    setReady(false);
    setMessage("Password saved. You can now sign in to the customer portal.");
  }
  return (
    <main className="client-login-page">
      <section className="client-login-card">
        <div className="client-login-brand">
          <img src="/hamro-afno-logo.jpeg" alt="Hamro Afno Enterprises" />
          <span>
            <strong>Customer portal</strong>
            <small>Secure password setup</small>
          </span>
        </div>
        ...
        <a className="client-login-link" href="/client-login">
